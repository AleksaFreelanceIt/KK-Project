...
struct LICMPass : public LoopPass {
    ...
    bool isGoodInstruction(const Instruction *I) {
        return GoodInstructions.count(I->getOpcode());
    }

    bool isHoistableInstruction(
        Instruction *I, std::unordered_set<Instruction *> &HoistableLoads,
    ...
    void
    findHoistableInstructions(const Loop *L,
                              std::unordered_set<Instruction *> &HoistableLoads,
    ...
    void moveHoistableLoads(BasicBlock *LoopPreheader,
                            const std::vector<Instruction *> &ToHoist) {
...
std::unordered_set<unsigned int> LICMPass::GoodInstructions = {
    ...
    Instruction::FNeg,   Instruction::ZExt,         Instruction::SExt,
    Instruction::Trunc,  Instruction::FPExt,        Instruction::FPTrunc,
    Instruction::FPToUI, Instruction::FPToSI,       Instruction::UIToFP,
    Instruction::SIToFP, Instruction::BitCast,      Instruction::ICmp,
    Instruction::FCmp,   Instruction::GetElementPtr};

    static RegisterPass<LICMPass>
    X("licm-pass", "The implementation of the LICM pass for the KK project");
